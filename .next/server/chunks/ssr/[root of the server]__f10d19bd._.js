...
function AccountSettingsPage() {
    ...
    const fetchAccountData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (user)=>{
        ...
        try {
            ...
            const fetchedSettings = settingsData;
            setUserSettings(fetchedSettings);
            const currentTemplates = fetchedSettings?.default_email_templates ? fetchedSettings.default_email_templates : defaultAllTemplates;
            settingsForm.reset({
                ...
                cadenceFu1: fetchedSettings?.follow_up_cadence_days?.[0] ?? defaultCadence[0],
                cadenceFu2: fetchedSettings?.follow_up_cadence_days?.[1] ?? defaultCadence[1],
                cadenceFu3: fetchedSettings?.follow_up_cadence_days?.[2] ?? defaultCadence[2],
