...
function AppLayout({ children }) {
    ...
    const [userSettingsFullName, setUserSettingsFullName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const fetchSettingsFullName = async (userId)=>{
            setIsLoadingSettings(true);
            try {
                const { data: settingsData, error: settingsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('user_settings').select('full_name').eq('user_id', userId).single();
                if (settingsError && settingsError.code !== 'PGRST116') {
                    throw settingsError;
                }
                setUserSettingsFullName(settingsData?.full_name || null);
            } catch (error) {
                console.error("Error fetching user settings full_name:", error.message);
                setUserSettingsFullName(null); // Fallback if error
            } finally{
        ...
        const handleAuthChange = async (currentSessionUser)=>{
            ...
            setUserSettingsFullName(null); // Reset on user change
            if (currentSessionUser) {
                await fetchFavoriteJobOpenings(currentSessionUser.id);
                await fetchSettingsFullName(currentSessionUser.id);
            } else {
                setFavoriteJobOpenings([]);
                setIsLoadingSettings(false); // No settings to load if no user
            }
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.getSession().then(async ({ data: { session: initialSession } })=>{
            ...
            await handleAuthChange(initialUser); // Sets user, fetches settings, sets isLoadingAuth to false
    ...
    const handleSignOut = async ()=>{
        setIsLoadingAuth(true); // Indicate loading during sign out
        ...
        // onAuthStateChange will handle setting user to null and isLoadingAuth to false
        if (error) {
            toast({
    ...
    if (PUBLIC_PATHS.includes(pathname)) {
        ...
        if (user && !isLoadingAuth) {
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                lineNumber: 201,
                columnNumber: 13
            }, this); // Show loader while redirecting
        }
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
            children: children
        }, void 0, false); // No user, auth loaded, on public path - show children
    }
    // At this point, if isLoadingAuth is false, and we are on a private path:
    // if !user, the useEffect should have redirected. If it hasn't yet, show loader.
    if (!user && !isLoadingAuth) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "flex h-screen w-screen items-center justify-center bg-background",
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
    ...
    const userDisplayNameToShow = userSettingsFullName || user?.user_metadata?.full_name || user?.email || 'User';
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__893dc6b2._.js.map